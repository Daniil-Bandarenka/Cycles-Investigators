...
try:
    driver.get(url="https://swgsmessenger.energytransfer.com/ipost/SWGS/capacity/operationally-available-by-location?max=10")
    ...
    driver.get_screenshot_as_file(f'{dir_path}/../075_screens/screen:{now}.png')
