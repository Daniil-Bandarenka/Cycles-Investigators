...
try:
    driver.get(url="https://rovermessenger.energytransfer.com/ipost/ROVER/capacity/operationally-available-by-location")
    ...
    driver.get_screenshot_as_file(f'{dir_path}/../019_screens/screen:{now}.png')
