...
try:
    driver.get(url="https://gstmessenger.energytransfer.com/ipost/GST/capacity/operationally-available-by-location?max=10")
    ...
    driver.get_screenshot_as_file(f'{dir_path}/../076_screens/screen:{now}.png')
